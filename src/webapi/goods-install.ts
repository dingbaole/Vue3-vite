...
export const LoadPageInitRuleGoodsInstall = () => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/load-page-init-data.action`,
    {
      method: 'POST',
      body: null
    }
...
export const CheckBaseRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/check-base-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const CanusedlGoodsList = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/canused-goods-list.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const AddSaveBaseRule = (params: ISaveBaseRule) => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/add-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const EditSaveBaseRule = (params: ISaveBaseRule) => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/edit-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const RemoveRule = (
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/remove-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const QueryBaseRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/query-base-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }

<template>
  <el-card shadow="never">
    <el-form :inline="true" :model="formData" :rules="rules" ref="ruleFormRef">
      ...
      <el-form-item>
        <el-button
          v-permission="'excitation:rule:stat-material-list'"
          type="primary"
          @click="search"
  ...
  <el-card shadow="never" style="margin-top: 10px">
    <el-button
      v-permission="'excitation:rule:stat-material-asyn-export'"
      type="primary"
      @click="exportData"
    ...
    >
      ...
      <el-table-column
        ...
        width="150"
      />
      <el-table-column label="物料号" property="materialNo" width="100" />
      <el-table-column label="物料名称" property="materialName" width="260" />
      <el-table-column
        label="销售数量"
        property="quantity"
        width="90"
...
import {
  ...
  MaterialStatisticsExport
} from '@/webapi/statistics'
import type { Material } from '@/webapi/statistics'
...
const exportData = async () => {
  await ruleFormRef.value.validate(valid => {
    if (valid) {
      ...
      MaterialStatisticsExport({ ...params }).then(res => {

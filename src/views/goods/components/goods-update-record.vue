...
import { QueryHistoryOperlog } from '@/webapi/goods'
...
const getList = (comnanyGoodsExcitationRuleId: number, companyId: number) => {
  pageData.loading = true
  QueryHistoryOperlog({ comnanyGoodsExcitationRuleId, companyId }).then(res => {
...
const toggleDialogStatus = (
  ...
  if (!dialogShow.value) {
    getList(comnanyGoodsExcitationRuleId, companyId)
  }

...
import { QueryHistoryOperlog } from '@/webapi/material'
...
const getList = (
  ...
  QueryHistoryOperlog({ comnanyMaterialExcitationRuleId, companyId }).then(
    res => {
...
const toggleDialogStatus = (
  ...
  if (!dialogShow.value) {
    getList(comnanyMaterialExcitationRuleId, companyId)
  }

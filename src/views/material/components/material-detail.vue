<template>
  ...
  >
    ...
    <div class="module-box">
      <div class="module-box-desc">3.适用物料范围</div>
      <div class="module-box-content">
        <el-table
          :data="detail.materialUsedRuleOutputs"
          border
    ...
    <div class="module-box">
      <div class="module-box-desc">4.可使用激励物料的服务范围</div>
      <el-alert type="warning" :closable="false">
        说明：非必选，不选择指定服务项目时，即在任何服务项目下使用激励物料时，系统都计算物料激励。
      </el-alert>
      <div class="module-box-content">
        <el-table
          :data="detail.serviceItemRelationOutputList"
          border
          style="width: 100%; margin-top: 15px"
        >
...
import { ref } from 'vue'
import { QueryBaseRule } from '@/webapi/material'
...
const detail = ref({
  ...
  materialUsedRuleOutputs: [],
  serviceItemRelationOutputList: []
})

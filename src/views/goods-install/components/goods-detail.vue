    ...
    <div class="module-box">
      ...
      <div class="module-box-content">
        ...
        <span style="display: initial; margin-left: 20px"
          >企业店铺 : {{ detail.shopName }}(店铺编码:
          {{ detail.thirdShopNo }})</span
        >
      </div>
    </div>
    <div class="module-box">
      ...
      <div class="module-box-content">
        ...
        <span v-if="detail.ladderType === LadderType.Y"
          >阶梯激励: 自定义成交单价区间</span
        >
...
const toggleDialogStatus = (
  ...
  if (!dialogShow.value) {
    ...
    if (companyInstallExcitationRuleId && companyId) {
      init(companyInstallExcitationRuleId, companyId, marketShopId)
    }
  }

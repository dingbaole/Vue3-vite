...
export const GetRerunStatus = (params: {
  ...
  }>(`/hradmin/excitation/rerun-company-install-rule/get-rerun-status.action`, {
    method: 'POST',
...
export const DraftRuleList = (params: {
  ...
  >(`/hradmin/excitation/rerun-company-install-rule/draft-rule-list.action`, {
    method: 'POST',
    body: JSON.stringify(params)
  })
}
...
export const PullValidRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/pull-valid-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
// 重置草稿规则
export const ResetGoodsRule = (params: { marketShopId: number }) => {
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/reset-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const DeleteGoodsRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/delete-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const StartRerunCalc = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/start-rerun-calc.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
// 重跑结果列表
export const GetRerunCalcResult = (
  params: {
    orderExcitationCalculateWorkId: number
  } & Page
) => {
  return Fetch<{
    ...
    `/hradmin/excitation/rerun-company-install-rule/get-rerun-calc-difference-list.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const GetRerunCalcResultExport = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/rerun-calc-difference-asyn-export.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const ReturnPrevStep = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/return-previous-step.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export interface CalcResult {
  ...
  /**
   * 集市订单号 orderNo order_no
   */
  orderNo: string

  /**
   * 关联服务订单号 orderNo order_no
   */

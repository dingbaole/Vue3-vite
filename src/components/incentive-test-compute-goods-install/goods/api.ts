...
export interface OperGoodsDetailInput {
  ...
  draftCompanyInstallExcitationRuleId?: number
  checked?: boolean
  calcType: 10 | 11
}
...
export interface ISaveBaseRule {
  ...
  operMaterialDetailInputList?: OperGoodsDetailInput[]
...
// 初始化页面数据（激励类型、状态接口）
export const LoadPageInitRuleGoodsInstall = () => {
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/load-page-init-data.action`,
    {
      method: 'POST',
      body: null
    }
...
export const RuleList = (params: IRuleList & Page) => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/base-rule-list.action`,
    {
      method: 'POST',
...
export const RuleExport = (params: IRuleList) => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/base-rule-export.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const CheckBaseRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/check-draft-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const GoodsOperateRecord = (
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/item-operate-record.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const CanusedlGoodsList = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/market-goods-list.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const AddSaveBaseRule = (params: ISaveBaseRule) => {
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/add-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const EditSaveBaseRule = (params: ISaveBaseRule) => {
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/edit-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const RemoveRule = (
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/remove-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const QueryBaseRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/rerun-company-install-rule/query-draft-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const OpenBaseRule = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/open-base-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const CloseBaseRule = (
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/close-base-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const CloseServiceItemRule = (
  params: Array<{
    companyInstallExcitationRuleMaterialRelationId: number
    draftCompanyInstallExcitationRuleId: number
    companyId: number
    goodsId: string
    materialId: number
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/close-goods-rule.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const ViewExcitationGoods = (params: ISetList & Page & Page3) => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/view-excitation-goods.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const CountList = (params: { companyId: number }) => {
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/count-list.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const QueryHistoryOperlog = (params: {
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/query-history-operLog.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }
...
export const UnusedList = (
  ...
  return Fetch(
    `/hradmin/excitation/company-goods-install-rule/unused-list.action`,
    {
      method: 'POST',
      body: JSON.stringify(params)
    }

<template>
  <div class="compute-panel">
    ...
    <div class="button-group">
      ...
      <el-button
        v-show="active === 1"
        v-permission="'excitation:rerun-company-install-rule:get-rerun-status'"
        type="primary"
        :loading="nextLoading"
        @click="next"
      >
      ...
      <el-button
        ...
        "
        v-permission="
          'excitation:rerun-company-install-rule:return-previous-step'
        "
        type="warning"
      ...
      <el-button
        v-permission="
          'excitation:rerun-company-install-rule:rerun-calc-difference-'
        "
      ...
      <el-button
        v-show="active === 2"
        v-permission="'excitation:rerun-company-install-rule:rstart-rerun-calc'"
        type="success"
        :disabled="resetLoading"
